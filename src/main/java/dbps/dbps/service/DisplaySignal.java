...
public class DisplaySignal {
    ...
    public void initialize_ASCii(){
        ...
        SignalMap_ASC.put("08D-P16D2S23 - 9^1", "0528231");
    ...
    public void initialize_HEX(){
        SignalMap_HEX.put("32D-P16D1S11", "00 07 49 00 20 01 11");//01 01 10 03
        ...
        SignalMap_HEX.put("08D-P16D2S23 - 9^1", "00 07 49 00 08 02 31");
        ...
        SignalMap_ASC.put("04D-P32D2S11", "00 07 49 00 04 02 11");
        SignalMap_ASC.put("04D-P32D2S21", "00 07 49 00 04 02 21");
        SignalMap_HEX.put("04D-P32D2S31 - 2 < 1 ^ 4 < 3", "00 07 49 00 04 02 31");
